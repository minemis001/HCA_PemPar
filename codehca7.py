...
N = 1000
TARGET = 5
NDIM = 7  # ganti angka ini saja kalau mau tambah dimensi lagi
...
for i in range(local_n):
    umur, pend, freq, waktu, dur, tiket, kep = local_data[i]
    ...
    for c in range(N):
        if active[c]:
            ...
            print(f"  Klaster {c}: {len(anggota)} penonton | "
                ...
                f"kepuasan {kep_mean:.1f}")
            
#cd "d:/semester 4/PemPar/tugas/projek uts"
#mpiexec -n 10 "C:\Users\ACER\AppData\Local\Python\pythoncore-3.14-64\python.exe" codehca7.py  